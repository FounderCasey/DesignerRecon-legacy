  ...
  <div class="welcome">
    <div class="header">
      ...
      <div class="hcontainer">
        ...
        <form class="fsub" @submit.prevent='subscribe'>
            <div id="signup">
              <input type="email" v-model="email" placeholder="Your email address" class="special-input" required>
              <input type="submit" class="special-submit">
            </div>
        </form>
      </div>
    </div>
